...
export function ParcoursCategorie1({ onContinuer }) {
  return (
    <div className="fixed inset-0 bg-ground text-ink overflow-y-auto z-50">
      <div className="p-4 flex flex-col gap-4 max-w-md mx-auto">
        <header>
          <h1 className="text-20 font-bold text-urgent-ink">Suspicion de danger sanitaire de catégorie 1</h1>
        ...
        <section className="border border-rule-strong bg-urgent-bg rounded p-3">
          <p className="text-13 font-bold text-urgent-ink mb-2">Conduite à tenir, dès maintenant :</p>
          <ul className="text-13 text-urgent-ink list-disc pl-5 flex flex-col gap-1">
        ...
        <section>
          <p className="text-13 font-bold mb-1">Déclaration obligatoire</p>
        ...
        <section>
          <p className="text-13 font-bold mb-1">Prélèvement attendu</p>
          <p className="text-13 text-ink-secondary">
        ...
        <section>
          <p className="text-13 font-bold mb-1">Test de l'allumette — orientation seulement</p>
          <ul className="text-13 text-ink-secondary list-disc pl-5 flex flex-col gap-1">
        ...
        <button
          type="button"
          onClick={onContinuer}
          className="h-[46px] w-full rounded bg-urgent-ink text-surface text-15 font-bold"
        >
